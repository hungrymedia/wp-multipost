...
== Changelog ==
= 2.3 =
* BUG FIX: Set child post published & modified dates/times to match the parent post dates/times (hungrymedia)
	[http://wordpress.org/support/topic/plugin-multipost-mu-child-posts-dont-inherit-publish-date]
